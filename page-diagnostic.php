<?php get_header(); ?>
    ...
    <section class="diagnostic__retangle">
        <div class="container">
            <div class="row">
                <div class="col-xl-3">
                    <img src="<?php bloginfo('template_directory') ?>/img/diagnostic-retangle.svg" class="revealator-slideright revealator-once" alt="diagnostic-retangle">
                </div>
                <div class="col-xl-9">
                    <h6 class="revealator-slideleft revealator-once">В работе мы используем лучшее диагностическое оборудование.</h6>
                    <p class="revealator-slideleft revealator-once">Все наши специалисты обеспечены средствами индивидуальной защиты.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="diagnostic__service-bg2">
                <div class="container">
                    ...
                    <div class="service__item">
                        ...
                        <p class="revealator-slideup revealator-once">Обнаружить наличие антител IgG поможет кровь, забранная из вены. При этом положительный
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="service__card revealator-slideup revealator-delay2 revealator-once">
                                        ...
                                        <div class="card__divider"></div>
                                        <div class="card__service">
                                            <p>Цена одного исследования: <span> 4 100 ₽</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="service__item">
                        ...
                        <p class="revealator-slideup revealator-once">ЭКГ – наиболее простой и, вместе с тем, крайне информативный метод обследования. ЭКГ представляет
                        ...
                        <h5 class="revealator-slideup revealator-once">ЭКГ позволяет диагностировать различные виды патологии сердца. По ЭКГ возможно:</h5>
                    ...
                    <div class="service__item">
                        ...
                        <div class="diagnostic-item__adv">
                            <h5>Преимущества диагностики:</h5>
                            <div class="row">
                                <div class="col-lg-3 col-md-6">
                                    <div class="item-adv__card revealator-slideup revealator-once">
                                        <div class="item-adv__card__img gold">
                                            <img src="<?php bloginfo('template_directory') ?>/img/diag-icon-1.svg" alt="advantage-icon">
                                        </div>
                                        <p>безопасность</p>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <div class="item-adv__card revealator-slideup revealator-delay1 revealator-once">
                                        <div class="item-adv__card__img grey">
                                            <img src="<?php bloginfo('template_directory') ?>/img/diag-icon-2.svg" alt="advantage-icon">
                                        </div>
                                        <p>информативность</p>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <div class="item-adv__card revealator-slideup revealator-delay2 revealator-once">
                                        <div class="item-adv__card__img gold">
                                            <img src="<?php bloginfo('template_directory') ?>/img/diag-icon-3.svg" alt="advantage-icon">
                                        </div>
                                        <p>способность диагностировать патологии на самых ранних стадиях развития</p>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <div class="item-adv__card revealator-slideup revealator-delay3 revealator-once">
                                        <div class="item-adv__card__img grey">
                                            <img src="<?php bloginfo('template_directory') ?>/img/diag-icon-4.svg" alt="advantage-icon">
                                        </div>
                                        <p>возможность проводить динамическое наблюдение за состоянием пациента</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <div class="item-adv__card revealator-slideup revealator-once">
                                        <div class="item-adv__card__img grey">
                                            <img src="<?php bloginfo('template_directory') ?>/img/diag-icon-5.svg" alt="advantage-icon">
                                        </div>
                                        <p>отсутствие лучевой нагрузки</p>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6">
                                    <div class="item-adv__card revealator-slideup revealator-delay1 revealator-once">
                                        <div class="item-adv__card__img gold">
                                            <img src="<?php bloginfo('template_directory') ?>/img/diag-icon-6.svg" alt="advantage-icon">
                                        </div>
                                        <p>возможность диагностики детей с первых дней жизни</p>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6">
                                    <div class="item-adv__card revealator-slideup revealator-delay2 revealator-once">
                                        <div class="item-adv__card__img grey">
                                            <img src="<?php bloginfo('template_directory') ?>/img/diag-icon-7.svg" alt="advantage-icon">
                                        </div>
                                        <p>возможность проводить исследования неограниченное количество раз</p>
                                    </div>
                                </div>
                            </div>
                        </div>
